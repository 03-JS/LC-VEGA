    ...
    public class LanguageHelper
    {
        ...
        internal static readonly Dictionary<string, Dictionary<string, string>> Commands = new()
        {
            ["English"] = new()
            {
                ...
                ["stopTalking"]  = "shut up/stop/stop talking/Shut up VEGA/Stop VEGA/Stop talking VEGA",
            ...
            ["Spanish"] = new()
            {
                ...
                ["activateScanner"]  = "activa el escaner/activa el escaner avanzado/enciende el escaner/enciende el escaner avanzado",
